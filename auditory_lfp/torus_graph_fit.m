...
load('csd_lfp_filt_phases_lateral.mat');
lateral_phases_lfp = lfp;
lateral_phases_csd = csd;

load('csd_lfp_filt_phases_medial.mat');
...
% Save results
save('twoprobe_tg.mat','twoprobe_csd_pvals','twoprobe_lfp_pvals','phi_hat_lfp','phi_hat_csd', '-v7')
...
save('bootstrap_pplv_tg.mat',  'partial_plv_csd')