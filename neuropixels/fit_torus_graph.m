...
% Load files generated by fit_gpcsd_baseline.py -- may need to change working dir or paths
load('results/neuropixel_csd_V1_phases.mat');
theta_phases_v1 = theta;
beta_phases_v1 = beta;

load('results/neuropixel_csd_LM_phases.mat');
...
save('results/neuropixel_tg.mat','theta_pvals','beta_pvals','theta_phi','beta_phi', '-v7')
...
save('results/bootstrap_neuropixels.mat',  'pplv_theta', 'pplv_beta', '-v7')